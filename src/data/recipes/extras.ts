...
export const extras: Recipe[] = [
  {
    ...
    babySteps: [
      ...
      'Vepřovou kýtu pro dceru duš zvlášť v troše vody čtyřicet minut a rozvláknej ji napříč svalem.',
    ],
    babyServing: {
      '6m': 'Podávej nudličku dušeného zelí přeloženou přes prst a kroupy slepené do hrudky, kterou dcera sevře v dlani.',
  ...
  },
  {
    ...
    babyServing: {
      '6m': 'Podávej hranolek ztuhlé polenty velikosti prstu a plátek měkkého fenyklu, který dcera uchopí celou dlaní.',
      '9m': 'Polentu nakrájej na kostičky, fenykl na proužky a rybí vločky rozlož vedle ke sbírání špetkou.',
      '12m': 'Servíruj měkkou polentu v misce s fenyklem a rybou navrch; dcera už si porci míchá a nabírá sama.',
    },
    meatSteps: [
  ...
  },
  {
    ...
    babySteps: [
      ...
      'Dužinu rozmačkej vidličkou do omáčky nebo ji nakrájej na proužky podle toho, co dcera zvládá.',
    ...
    babyServing: {
      ...
      '12m': 'Servíruj porci v misce se lžící; dcera už zvládne nabrat zapečený lilek i s omáčkou sama.',
    },
    meatSteps: [
  ...
  },
  {
    ...
    babySteps: [
      ...
      'Kapustu nasekej nadrobno; nudličky jsou pro dceru dlouhé a v puse se motají.',
    ...
    babyServing: {
      ...
      '12m': 'Servíruj polévku v misce se lžící a celými fazolemi rozmačkanými napůl; dcera už jí samostatně.',
    },
    meatSteps: [
  ...
  },
  {
    ...
    babySteps: [
      ...
      'Tvaroh zřeď lžící vody nebo mléka, aby nebyl hutný a dcera ho snadno polykala.',
    ...
    babyServing: {
      ...
      '9m': 'Nakrájej nektarinku na kostičky a tvaroh nech hustší; dcera si obojí sbírá špetkou z mělké misky.',
      '12m': 'Servíruj vrstvenou misku se lžící a nech dceru, ať si ovoce do tvarohu sama zamíchá.',
    },
    meatSteps: [
  ...
  },
  {
    ...
    babySplitPoint:
      'Po kroku 2 odeber tři lžíce těsta stranou a upeč z nich dceřiny placky, dřív než se zbytek těsta pro dospělé dochucuje.',
    babySteps: [
    ...
    babyServing: {
      '6m': 'Podávej pásek placky dlouhý přes dlaň a jogurt v ploché misce, do které dcera zaboří konec pásku.',
      '9m': 'Placku nalam na kousky velikosti nehtu a jogurtový dip podávej vedle ke smáčení prsty.',
      '12m': 'Nabídni celou placku do ruky s miskou dipu; dcera si ji sama trhá a namáčí.',
    },
    meatSteps: [
