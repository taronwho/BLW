    ...
    sections: [
      {
        ...
        body: [
          ...
          'Pryč s tvary, které ucpou dýchací cesty. Ze stolu mizí celé ořechy, celé hroznové víno a bobule, kulaté plátky párku, tvrdá syrová mrkev, karamely a hrudka ořechového másla na lžíci.',
        ],
      },
      {
